...
function drawChart(){
  ...
  data.addRows([
	    ['탄수화물', Number($("#_fcar").html())],
	    ['단백질', Number($("#_fpro").html())],
	    ['지방', Number($("#_ffat").html())],  
	    ['당류', Number($("#_fsugar").html())],
	    ['나트륨', Number($("#_fnat").html())/1000],
	    ['콜레스테롤', Number($("#_fchol").html())/1000],
	    ['포화지방산', Number($("#_fsat").html())/1000],
	    ['트랜스지방', Number($("#_ftran").html())/1000]  
]);      
  // Set chart options
  // 차트 설정 옵션
  var options = {'title' : '영양 성분표', 'width' :800, 'height' : 500};
			...
			<div class="header">
				<div class="cssmenu">
					<ul>
						...
						<li><a href="service.jsp">먹거리 정보</a></li>
								...
								<div class="image-box style-3-b">
									...
									<c:if test="${not loop_flag}">
										<c:if test="${fn:contains(food.materials,alle)}">
											...
											<table>
												<tr>
													<td><img src="${food.imgSrc }" alt="" height="500px">
													</td>

													<td id="chart_div">
																					<c:set var="loop_flag" value="false" />
														<div id="_fname" style="display: none">${food.name }</div>
														<div id="_fman" style="display: none">${food.manufacturer }</div>
														<div id="_fmat" style="display: none">${food.materials }</div>
														<div id="_fweight" style="display: none">${food.weight }</div>
														<div id="_fcal" style="display: none">${food.calories }</div>
														<div id="_fcar" style="display: none">${food.carbohydrate }</div>
														<div id="_fpro" style="display: none">${food.protein }</div>
														<div id="_ffat" style="display: none">${food.fat }</div>
														<div id="_fsugar" style="display: none">${food.sugar }</div>
														<div id="_fnat" style="display: none">${food.natrium }</div>
														<div id="_fchol" style="display: none">${food.cholesterol }</div>
														<div id="_fsat" style="display: none">${food.saturatedFat }</div>
														<div id="_ftrans" style="display: none">${food.transFat }</div>
													</td>
												</tr>
											</table>
										</div>
										<div class="col-lg-8 col-xl-7 pv-30">
											...
											<div class="product elements-list">
												...
												<div class="btn-group">
													<a
														href="http://1.231.235.199:8080/SafeFood/foodView.do?pageNo=1&amp;code=20&amp;query=null&amp;key=name&amp;word=#"
														onclick="addIntakeFood(20)" class="btn btn-default btn-sm"><i
														class="fa fa-user pr-2"></i> 추가</a>
												</div>
											</div>
										</div>
									</div>
