...
<html>
<head>
<title>SSAFY's Park & Yu Responsive WEB</title>
			...
			<div class="header">
				<div class="cssmenu">
					<ul>
						...
						<li class="has-sub"><a href="bfservice.jsp">먹거리 정보</a></li>
				...
				<div class="search">
					<form id="_fosearch" action="<%=request.getContextPath()%>/main.do" method="post">
						<input type="hidden" name="action"value="search"/>
						<input type="text" name="keyword" value="" placeholder=""><button id="searchBtn" onclick="search()"></button>
					</form>
				</div>
				<div class="clear"></div>
			</div>
		...
		<div class="wrapper">
			...
			<div class="fluid_container">
				<div class="camera_wrap camera_emboss pattern_1" id="camera_wrap_4">
					...
					<div data-src="images/pic1.jpg"></div>
		...
		<div class="wrapper">
			<div class="main_bg">
				<div class="main">
					<div class="content">
						<h2>안전한 음식 찾기</h2>
						<a href="index.jsp"><h3>SSAFY's</h3></a>
					</div>
				</div>
				<div class="clear"></div>
			</div>
							...
							<div class="grid_1_of_3 images_1_of_3">
								...
								<div class="g">
									...
									<div class="rd_more" align="right">
										<form action="<%=request.getContextPath()%>/main.do" method="post"  class='_fo2'>
					...
					<div class="main1">
						<div class="section group">
							<div class="grid_1_of_3 images_1_of_3">
								...
								<div class="gallery">
									<a href="images/pic1.jpg"><img src="images/pic1.jpg"
										title="image-name"></a>
								</div>
								<p class="para">우리는 먹거리에 대해 분석하여 고객님들께 안전한 먹거리 정보를 제공합니다.</p>
								<div class="rd_more">
								</div>
							</div>
							<div class="grid_1_of_3 images_1_of_3">
								<h2 class="style">why choose us?</h2>
								<div class="text1-nav">
									<ul>
										<li><a href="">먹거리에 대한 영양 정보를 제공합니다.</a></li>
										<li><a href="">먹거리에 대한 영양 정보를 제공합니다.</a></li>
										<li><a href="">먹거리에 대한 영양 정보를 제공합니다.</a></li>
										<li><a href="">먹거리에 대한 영양 정보를 제공합니다.</a></li>
										<li><a href="">먹거리에 대한 영양 정보를 제공합니다.</a></li>
							...
							<div class="grid_1_of_3 images_1_of_3">
								<h2 class="style">Recent forums</h2>
								<div class="text1-nav">
									<p class="date top">19-03-14</p>
									<p class="para top">전남 광양시는 이순신대교 먹거리 타운의 '문화를 더(T·H·E)한 발섬길 사업'이 전남도 주관 '공공디자인 특화거리 조성사업' 공모에 선정됐다고 14일 밝혔다.
이 사업은 보행환경과 편의시설이 부족한 이순신대교 먹거리타운 일대 1.2㎞, 14만1000㎡에 광양의 맛을 더하고 가로경관의 조화로움을 더해 즐거운 먹거리 타운을 조성하는 것이다.
</p>
									<div class="rd_more">
									<a href="http://news1.kr/articles/?3571170" class="btn">more</a>
									</div>
								</div>
								<div class="text1-nav">
									<p class="date top">19-03-14</p>
									<p class="para top">경기 파주시(시장 최종환)는 지난 13일 문산 자유시장 식품취급업소를 대상으로 2019년 ‘깔끔음식업소 만들기’ 사업 설명회를 실시했다.이는 열악한 시설환경과 영세성으로 위생수준이 낮은 전통시장내 식품취급업소의 조리장, 화장실 등 시설개선 지원을 통해 식품안전사고를 사전에 예방하고 안전한 먹거리 확보로 전통시장 활성화하고자 추진됐다. </p>
									<div class="rd_more">
										<a href="http://www.wikitree.co.kr/main/news_view.php?id=411325" class="btn">more</a>
									</div>
								</div>
							</div>
							<div class="clear"></div>
